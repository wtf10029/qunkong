...
<head>
    ...
    <style type="text/css">
        *{ padding: 0; margin: 0; }
        ...
        .system-message{position:absolute;top:10%;left:50%;transform:translate(-50%,-80%); padding: 24px 48px; margin:auto; border: #CCC 3px solid; top:10%; width:500px; border-radius:10px;
